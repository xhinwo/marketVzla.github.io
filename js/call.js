...
const asideVideo = document.querySelector('.aside-video')
...
const imputNavegacion = document.querySelector('.input-navigation')
const btnNavegacion = document.querySelector('.button-navigation')
const productosNavegacion = document.querySelector('.productos-navegacion')
